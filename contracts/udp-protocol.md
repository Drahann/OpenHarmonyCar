...
**版本 v0.3（2026-06-14）** — 字节布局/命令语义已与**紫派实现** `purplepi-control/NewWheelCtrl/udp2lcm/` **逐字段对账**；心跳 byte1/byte2 正式用于协同避障状态与事件回传。
...
| 1 | `coopStatus` | uint8 | 协同避障状态，见下表 |
| 2 | `coopEvent` | uint8 | 协同避障事件，见下表 |
