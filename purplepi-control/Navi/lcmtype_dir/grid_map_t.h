...
typedef void(*grid_map_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const grid_map_t *msg, void *userdata);
 ...
 */
grid_map_t_subscription_t* grid_map_t_subscribe(lcm_t *lcm, const char *channel, grid_map_t_handler_t handler, void *userdata);
